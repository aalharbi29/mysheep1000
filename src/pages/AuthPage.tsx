      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {!isLogin && (
              <div className="space-y-2">
                ...
                <Input id="name" type="text" value={displayName} onChange={(e) => setDisplayName(e.target.value)} placeholder="أدخل اسمك" required={!isLogin} />
              </div>
            )}
            ...
            {(isLogin ? loginMethod : signupMethod) === 'phone' ? (
              <div className="space-y-2">
                ...
                <Input id="phone" type="tel" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="966XXXXXXXXX" required dir="ltr" />
                {isLogin && (
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input id="password" type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" required minLength={6} dir="ltr" className="pl-10" />
          ...
          <div className="mt-4 text-center">
            <button type="button" onClick={() => { setIsLogin(!isLogin); setLoginMethod('email'); setSignupMethod('email'); }} className="text-sm text-primary hover:underline font-bold">
