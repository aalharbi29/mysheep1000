...
const SummaryPage = () => {
  ...
  return (
    <div className="min-h-screen p-4 sm:p-6 py-0 mb-0 mt-0 rounded-3xl border-solid border-4 bg-gray-900">
      <div className="max-w-2xl mx-auto mt-[100px] pb-[15px] bg-primary-foreground rounded-3xl border-4 border-accent text-center">
