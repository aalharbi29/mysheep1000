          ...
          {breeds.map((breed) => {
            return (
              <button
                ...
                className="p-6 text-center transition-all duration-200 card-shadow hover:card-shadow-hover hover:scale-[1.02] active:scale-[0.98] shadow-2xl bg-[#dad0c8] rounded-3xl">
