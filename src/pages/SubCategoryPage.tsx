...
const SubCategoryPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background p-4 sm:p-6">
      <div className="max-w-2xl mt-[100px] mx-0 px-[5px] rounded-3xl shadow-2xl bg-[#d3cfcf] pb-[20px] pt-[10px]">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <button
            ...
            className="rounded-xl p-5 text-center transition-all duration-200 card-shadow hover:card-shadow-hover hover:scale-[1.02] active:scale-[0.98] shadow-2xl bg-[#dad0c8] mx-0">
